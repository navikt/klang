    ...
    <ContentContainer>
      <CenteredContainer>
        ...
        {props.success && (
          <Margin32Container>
            <Lenke
              ...
              href={getKlagePdfUrl(props.klageId)}
            >
        ...
        {props.finalizedDate && isValidDateString(props.finalizedDate) && (
          <Margin32Container>
            <Normaltekst>
              Sendt inn: {formatDate(new Date(props.finalizedDate))}
            </Normaltekst>
          </Margin32Container>
        )}
      </CenteredContainer>
      <Margin40Container>
        <AlertStripeSuksess className="fit-content">
          ...
          <Normaltekst>
            Du trenger ikke gjøre noe mer, vi tar kontakt med deg hvis det er
            noe vi lurer på eller hvis vi trenger flere opplysninger fra deg.
          </Normaltekst>
        </AlertStripeSuksess>
      </Margin40Container>
