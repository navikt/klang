...
export const getLoginserviceRedirectUrl = (pathBeforeRedirect: string): string =>
    `${Environment.REACT_APP_LOGINSERVICE_URL}?redirect=${Environment.REACT_APP_URL + pathBeforeRedirect}`;
