...
| ARBEID_MED_STOTTE | Arbeid med støtte | Employment support scheme | Arbeid med støtte |
| ARBEIDSAVKLARINGSPENGER | Arbeidsavklaringspenger (AAP) | Work assessment allowance (AAP) | Arbeidsavklaringspengar (AAP) |
| ARBEIDSFORBEREDENDE_TRENING | Arbeidsforberedende trening | Employment preparation training | Arbeidsførebuande trening |
| ARBEIDSRETTET_REHABILITERING | Arbeidsrettet rehabilitering | Occupational rehabilitation | Arbeidsretta rehabilitering |
| ARBEIDSTRENING | Arbeidstrening | Work training | Arbeidstrening |
| AVKLARING | Avklaring | Assessment | Avklaring |
...
| HJELPESTONAD | Hjelpestønad | Assistance allowance (Hjelpestønad) | Hjelpestønad |
| INKLUDERINGSTILSKUDD | Inkluderingstilskudd | Inclusion subsidy | Inkluderingstilskot |
| IPS | IPS | IPS | IPS |
| IPS_UNG | IPS ung | IPS Youth | IPS ung |
...
| JOBBSOKERKURS | Jobbsøkerkurs | Job seeker course | Jobbsøkjarkurs |
...
| MIDLERTIDIG_LONNSTILSKUDD | Midlertidig lønnstilskudd | Timelimited wage subsidies | Mellombels lønstilskot |
...
| OPPLARING | Opplæring | Training | Opplæring |
...
| SENTER_FOR_JOBBMESTRING | Senter for jobbmestring | Job coping centre | Senter for jobbmeistring |
...
| TILSKUDD_TIL_SOMMERJOBB | Tilskudd til sommerjobb | Summer job grants | Tilskot til sommarjobb |
...
| VARIG_LONNSTILSKUDD | Varig lønnstilskudd | Permanent wage subsidy | Varig lønstilskot |
| VARIG_TILRETTELAGT_ARBEID | Varig tilrettelagt arbeid | Permanent adapted work | Varig tilrettelagt arbeid |
